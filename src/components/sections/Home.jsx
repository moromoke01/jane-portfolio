...
export const Home = () =>{
    return (
        <section id="home" className="min-h-screen flex items-center pb-5 md:mb-20 justify-center relative">
            <div className="text-center z-10 px-10">
                ...
                <div className="flex justify-center space-x-4">
                    <a href= "#projects"
                       className="bg-gradient-to-r from-purple-900 to-blue-700 text-white py-3 px-3 md:px-6 rounded font-small md:font-medium transition relative overflow-hidden hover:translate-y-0.5 hover:shadow-[0_0_15px_rgba(59, 130, 246,0.4)]">View Project</a>

                       <a href= "#contact"
                       className="border border-purple-500/50 text-purple-500 py-3 px-3 md:px-6 rounded font-small md:font-medium hover:translate transition-all duration-200-y-0.5 hover:shadow-[0_0_15px_rgba(59, 130, 246,0.4)] hover:bg-purple-500/10"> Contact Me</a>
